...
public class AttendeeService {
    ...
    public void verifyAttendeeSubscription(String email, String eventId) {
        Optional<Attendee> isAttendeRegistered = this.attendeeRepository.findByEventIdAndEmail(eventId, email);
        if (isAttendeRegistered.isPresent()) throw new AttendeeAlreadyExistException("Attendee is already registered");
    }
